...
namespace LiveEvents.Api.Infrastructure.Adapters;

public class RepositoryBase<TEntity> : IRepositoryBase<TEntity> where TEntity : class
{
    internal readonly LiveEventsDbContext _context;
    private readonly ILogger<RepositoryBase<TEntity>> _logger;
    
    public RepositoryBase(LiveEventsDbContext context, ILogger<RepositoryBase<TEntity>> logger)
    {
        _context = context;
        _logger = logger;
