...
namespace LiveEvents.Api.Authentication.Application.UseCases.Users.Mappings;
...
public class UserProfile : Profile
{
    public UserProfile()
    {
        ...
        CreateMap<User, UserDto>()
            ...
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Status == UserStatus.Activo))
        ...
        CreateMap<UserDto, User>()
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Status ? UserStatus.Activo : UserStatus.Suspendido))
