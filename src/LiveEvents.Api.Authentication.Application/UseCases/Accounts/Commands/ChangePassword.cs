...
public class ChangePassword
{
    ...
    public ChangePassword(IRepositoryBase<User> userRepository, ISecurityStampService securityStampService)
    {
    ...
    public async Task<Result> HandleAsync(Guid userId, ChangePasswordDto changePasswordDto, CancellationToken cancellationToken)
    {
        ...
        await _securityStampService.RefreshSecurityStampAsync(user, cancellationToken);
